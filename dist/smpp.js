...
__export(smpp_exports, {
  ...
  ESME_RBCASTCANCELFAIL: () => ESME_RBCASTCANCELFAIL,
  ESME_RBCASTFAIL: () => ESME_RBCASTFAIL,
  ESME_RBCASTQUERYFAIL: () => ESME_RBCASTQUERYFAIL,
  ...
  ESME_RINVBCASTALIAS_NAME: () => ESME_RINVBCASTALIAS_NAME,
  ESME_RINVBCASTAREAFMT: () => ESME_RINVBCASTAREAFMT,
  ESME_RINVBCASTCHANIND: () => ESME_RINVBCASTCHANIND,
  ESME_RINVBCASTCNTTYPE: () => ESME_RINVBCASTCNTTYPE,
  ESME_RINVBCASTFREQINT: () => ESME_RINVBCASTFREQINT,
  ESME_RINVBCASTMSGCLASS: () => ESME_RINVBCASTMSGCLASS,
  ESME_RINVBCASTSRVGRP: () => ESME_RINVBCASTSRVGRP,
  ESME_RINVBCAST_REP: () => ESME_RINVBCAST_REP,
  ESME_RINVBNDSTS: () => ESME_RINVBNDSTS,
  ESME_RINVCMDID: () => ESME_RINVCMDID,
  ESME_RINVCMDLEN: () => ESME_RINVCMDLEN,
  ESME_RINVDCS: () => ESME_RINVDCS,
  ESME_RINVDESTFLAG: () => ESME_RINVDESTFLAG,
  ESME_RINVDFTMSGID: () => ESME_RINVDFTMSGID,
  ESME_RINVDLNAME: () => ESME_RINVDLNAME,
  ESME_RINVDSTADDRSUBUNIT: () => ESME_RINVDSTADDRSUBUNIT,
  ...
  ESME_RINVNUMBCAST_AREAS: () => ESME_RINVNUMBCAST_AREAS,
  ...
  ESME_RINVSRCADDRSUBUNIT: () => ESME_RINVSRCADDRSUBUNIT,
  ...
  ESME_RINVTLVLEN: () => ESME_RINVTLVLEN,
  ESME_RINVTLVSTREAM: () => ESME_RINVTLVSTREAM,
  ESME_RINVTLVVAL: () => ESME_RINVTLVVAL,
  ESME_RMISSINGTLV: () => ESME_RMISSINGTLV,
  ESME_RMSGQFUL: () => ESME_RMSGQFUL,
  ESME_ROK: () => ESME_ROK,
  ESME_RPROHIBITED: () => ESME_RPROHIBITED,
  ESME_RQUERYFAIL: () => ESME_RQUERYFAIL,
  ESME_RREPLACEFAIL: () => ESME_RREPLACEFAIL,
  ESME_RSERTYPDENIED: () => ESME_RSERTYPDENIED,
  ESME_RSERTYPUNAUTH: () => ESME_RSERTYPUNAUTH,
  ESME_RSERTYPUNAVAIL: () => ESME_RSERTYPUNAVAIL,
  ESME_RSUBMITFAIL: () => ESME_RSUBMITFAIL,
  ESME_RSYSERR: () => ESME_RSYSERR,
  ESME_RTHROTTLED: () => ESME_RTHROTTLED,
  ESME_RTLVNOTALLWD: () => ESME_RTLVNOTALLWD,
...
module.exports = __toCommonJS(smpp_exports);
var import_net = __toESM(require("net"));
var import_tls = __toESM(require("tls"));
var import_util = __toESM(require("util"));
var import_url = require("url");
var import_events = require("events");
var import_findhit_proxywrap = require("findhit-proxywrap");
...
encodings.LATIN1 = {
  match: function(value) {
    return value === import_iconv_lite.default.decode(import_iconv_lite.default.encode(value, "latin1"), "latin1");
  },
  encode: function(value) {
    return import_iconv_lite.default.encode(value, "latin1");
  },
  decode: function(value) {
    return import_iconv_lite.default.decode(value, "latin1");
  }
};
encodings.UCS2 = {
  match: function(value) {
  ...
  encode: function(value) {
    return import_iconv_lite.default.encode(value, "utf16-be");
  },
  decode: function(value) {
    return import_iconv_lite.default.decode(value, "utf16-be");
  }
};
...
// src/smpp.ts
var proxyTransport = (0, import_findhit_proxywrap.proxy)(import_net.default, {
  strict: false,
  ignoreStrictExceptions: true
});
var proxyTlsTransport = (0, import_findhit_proxywrap.proxy)(import_tls.default, {
  strict: false,
  ignoreStrictExceptions: true
});
function Session(options) {
  ...
  var self = this;
  var clientTransport = import_net.default;
  var connectTimeout;
  ...
  if (options && options.socket) {
    ...
    options = options || {};
    if (options.tls) {
      clientTransport = import_tls.default;
    }
...
import_util.default.inherits(Session, import_events.EventEmitter);
...
function Server(options, listener) {
  ...
  if (this.isProxiedServer) {
    ...
    transport = this.tls ? import_tls.default : import_net.default;
  }
...
import_util.default.inherits(Server, import_net.default.Server);
import_util.default.inherits(SecureServer, import_tls.default.Server);
import_util.default.inherits(ProxyServer, proxyTransport.Server);
import_util.default.inherits(ProxySecureServer, proxyTlsTransport.Server);
...
function connect(options, listener) {
  ...
  if (arguments.length > 1 && typeof listener != "function") {
    ...
    clientOptions = (0, import_url.parse)(options);
    ...
    if (clientOptions.url) {
      options = (0, import_url.parse)(clientOptions.url);
