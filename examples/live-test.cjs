...
const HOST = process.env.HOST || '52.221.242.70';
const PORT = Number(process.env.PORT || 2775);
const SYSTEM_ID = process.env.SYSTEM_ID || 'test_002';
const PASSWORD = process.env.PASSWORD || '93e065d13274b86831287a36c24a490e';
